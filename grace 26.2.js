...
function grace(oh, my, intersect){
...
// Upper right
  if(intersect.x <= 320 && (intersect.y === 0)){
    X = 360 - (intersect.x)*(180 - intersect.y)/(320 - intersect.x)
    ctx.strokeStyle = "#dd3838";
    ctx.beginPath();
    ...
    my = X
    intersect(360, 100)
    grace(oh, my, intersect)
 
    }

// Upper left
  if(intersect.x >= 320 && (intersect.y === 0)){
    X = 180/(intersect.x - 320) * (640 - intersect.x)
    ctx.strokeStyle = "#dd3838";
    ctx.beginPath();
    ctx.moveTo(intersect.x,360);
    ctx.lineTo(640,360-X);
    ctx.stroke()
    oh = 640
    my = 360 - X
    grace(oh, my, intersect)
...
// RIGHT UPPER
  if(intersect.y <= 180 && (intersect.x === 640)){
    X = intersect.y * 320 / (180 - intersect.y)
    ctx.strokeStyle = "#dd3838";
    ctx.beginPath();
...
// LOWER RIGHT
  if(intersect.x >= 320 && (intersect.y === 360)){
    X = (640 - intersect.x) * 180 / (intersect.x - 320)
    ctx.strokeStyle = "#dd3838";
    ctx.beginPath();
    ctx.moveTo(intersect.x, 0);
    ctx.lineTo(640, X);
    ctx.stroke()
    oh = 640
    my = X
...
// LOWER LEFT
  if(intersect.x <= 320 && (intersect.y === 360)){
    X = intersect.x * 180 / (320 - intersect.x);
    ctx.strokeStyle = "#dd3838";
    ctx.beginPath();
    ctx.moveTo(intersect.x,0);
    ctx.lineTo(0, X);
